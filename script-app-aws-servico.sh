...
sudo su
echo "fs-014c9c12f3b1be45e.efs.us-east-1.amazonaws.com:/ /var/www/html/ nfs4 nfsvers=4.1,rsize=1048576,wsize=1048576,hard,timeo=600,retrans=2,noresvport,_netdev 0 0" >> /etc/fstab
mount -a
sudo wget https://pages.icarotech.com/aws/arquivos/suitecrm.zip
